...
export default function Sidebar() {
    ...
    return (
        <>
            <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-30 md:hidden" aria-hidden="true"></div>
            <aside id="mobile-sidebar" className="w-56 lg:w-64 bg-sidebar text-sidebar-foreground border-r border-border flex flex-col z-40 shrink-0 absolute md:relative h-full shadow-2xl md:shadow-none transition-all duration-200">
                {/* Brand Logo */}
                <div className="flex flex-col gap-2 p-0 shrink-0">
                    <div className="px-3 pt-4 flex items-center">
                        <NavLink to="/" className="cursor-pointer hover:opacity-80 transition-opacity outline-none focus-visible:ring-2 focus-visible:ring-primary/20 rounded-md block w-full text-left">
                            <img alt="Avesdo" className="h-[64px] w-auto px-3 py-4 object-contain" src="https://lh3.googleusercontent.com/d/1HgOfOymPbhh2hjSxeqiZmbe20o6uDlVk" />
                        </NavLink>
                    </div>
                </div>
