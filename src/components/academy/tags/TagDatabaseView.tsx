  ...
  return (
    <div className="flex flex-col h-full bg-white w-full relative">
      <div className="flex items-start justify-between mb-2 pb-0">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight mb-1">Tag Database</h2>
      ...
      <InteractiveBuilderModal isOpen={isBuilderOpen} onClose={() => setIsBuilderOpen(false)} />
    </div>
  );
}
