...
import { Smile, Frown, Meh, MessageSquare, ArrowRight } from 'lucide-react';
import { useUIStore } from '../../store/useUIStore';
import { SupportCsatMetric } from '../../utils/qualityUtils';
...
export function SupportCSATWidget({ data }: WidgetProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-border shadow-sm overflow-hidden flex flex-col xl:flex-row">
      ...
      <div className="w-full xl:w-[350px] border-b xl:border-b-0 xl:border-r border-border p-6 bg-slate-50/50 flex flex-col">
        <div>
          <h3 className="text-lg font-bold text-foreground">Support CSAT</h3>
          <p className="text-sm text-muted-foreground mt-1">
            Overall satisfaction score and breakdown
          </p>
        </div>
        ...
        <div className="space-y-4">
          <h4 className="text-sm font-bold text-slate-700">Feedback Breakdown</h4>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center">
                <Meh className="w-4 h-4 text-slate-600" />
              </div>
              <div>
                        ...
                        <div className="flex flex-col gap-3">
                          {[...payload]
                            ...
                            .map((entry: any, index: number) => {
                              ...
                              let labelText = '';
                              if (entry.dataKey === 'averageScore') labelText = 'Avg Score';
