    ...
    <div className="flex flex-wrap items-center gap-2 mt-0.5 mb-1 animate-in fade-in slide-in-from-top-1 px-1">
      ...
      {activeItems.map((item, idx) => (
        <span
          ...
          className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-white text-slate-700 ring-1 ring-inset ring-slate-500/20 border border-slate-200"
        >
