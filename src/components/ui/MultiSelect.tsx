...
export function MultiSelect({ 
  ...
  return (
    <div className={`relative inline-block ${className}`} ref={ref}>
      ...
      {isOpen && (
        <div className={`absolute top-full mt-2 bg-white border border-border rounded-xl shadow-xl z-[250] overflow-hidden flex flex-col max-h-[300px] animate-in fade-in zoom-in-95 duration-100 ${dropdownWidth} ${align === 'right' ? 'right-0' : 'left-0'} ${menuClassName}`}>
          {searchable && (
