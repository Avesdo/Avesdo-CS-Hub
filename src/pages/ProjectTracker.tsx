                    ...
                    {(nameFilter.length > 0 || clientFilter.length > 0 || managerFilter.length > 0 || timelineFilter.length > 0 || phaseFilter.length > 0 || statusFilter.length > 0 || healthFilter.length > 0 || featuresFilter.length > 0 || releaseDateFilter !== null) && (
                        <ActiveFilterBar 
                            filters={[
                                ...
                                { label: 'Delivery Status', values: timelineFilter, onRemove: (v) => removeFilterItem(setTimelineFilter, timelineFilter, v) },
                                { label: 'Implementation Milestone', values: phaseFilter, onRemove: (v) => removeFilterItem(setPhaseFilter, phaseFilter, v) },
