        ...
        <div className="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-3">
            {project?.onboarding?.survey && Object.keys(project.onboarding.survey).length > 0 && (
              <button
                onClick={() => exportFormToCSV('Onboarding Survey', project, project.onboarding.survey)}
        ...
        <div className="flex-1 overflow-y-auto p-6 lg:p-10 bg-slate-50 custom-thin-scroll">
          <div className="max-w-3xl mx-auto space-y-4">
            <div className="bg-blue-50 text-blue-800 p-4 rounded-xl border border-blue-200 mb-8 text-sm">
              <strong>Instructions:</strong> Please fill out the required survey questions below. Your progress will be saved to the project.
            </div>
