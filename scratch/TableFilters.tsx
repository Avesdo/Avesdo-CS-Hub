...
export const ColumnFilter = ({
  ...
  return (
    <MultiSelect
      ...
      trigger={
        <button
          className={`p-1 rounded transition-opacity ${selected.length > 0 ? 'opacity-100 text-white bg-slate-900 border border-slate-900 shadow-sm hover:bg-slate-800' : 'opacity-0 group-hover/th:opacity-100 text-slate-400 hover:bg-slate-200'}`}
        >
      ...
      <Popover.Root open={isOpen} onOpenChange={setIsOpen}>
        <Popover.Trigger asChild>
          <button
            ...
            className={`p-1 rounded opacity-0 group-hover/th:opacity-100 transition-opacity ${dateRange ? 'opacity-100 text-white bg-slate-900 border border-slate-900 shadow-sm hover:bg-slate-800' : 'text-slate-400 hover:bg-slate-200'}`}
          >
            <Filter className="w-3.5 h-3.5" />
          </button>
        </Popover.Trigger>
