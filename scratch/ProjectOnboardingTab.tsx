...
const MILESTONES = [
  ...
  { 
    ...
    getDescription: (phase: string, isCompleted: boolean, isPending: boolean, hasData: boolean, isSubmitted: boolean, status?: string) => {
...
export default function ProjectOnboardingTab({ project }: ProjectOnboardingTabProps) {
  ...
  return (
    <div className="pb-10" ref={popRef}>
      ...
      {/* 1. Top Section: Global Setup & Links (Sticky) */}
      <div className="sticky top-[0px] z-40 bg-white -mx-10 px-10 -mt-10 pt-10 pb-6 mb-8 border-b border-slate-100 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.08)] flex flex-col gap-8">
      ...
      {/* 2. Middle Section: The Implementation Timeline */}
      <div className="px-10 pt-8 pb-10 flex-1">
