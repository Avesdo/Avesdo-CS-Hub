        ...
        <div className="flex-1 overflow-y-auto p-6 lg:p-10 bg-slate-50 custom-thin-scroll">
          <div className="max-w-3xl mx-auto space-y-4">
            <div className="bg-blue-50 text-blue-800 p-4 rounded-xl border border-blue-200 mb-8 text-sm">
              <strong>Instructions:</strong> Please fill out the required project certification details below. Your progress will be saved to the project.
            </div>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-sm">
              {template ? (
                <DynamicForm 
                  ...
                  onSubmit={handleSave} 
                  onCancel={onClose}
                  submitLabel="Submit Certification"
                />
              ) : (
