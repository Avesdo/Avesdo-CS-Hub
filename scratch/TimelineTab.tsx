...
export function TimelineTab({
  ...
  return (
    <div className="flex flex-col h-full w-full -mt-10">
      ...
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur-md pt-6 pb-6 border-b border-slate-100/60 mb-6 w-[calc(100%+80px)] -ml-10 px-10">
            ...
            {Object.keys(groupedNotes).map((dateHeader) => (
              <div key={dateHeader} className="relative">
                ...
                <div className="sticky top-[140px] z-30 -ml-[19px] mb-6 flex items-center">
                  <div className="bg-white px-4 py-1.5 rounded-full border border-slate-200/60 shadow-sm text-[11px] font-bold text-slate-500 uppercase tracking-widest relative -left-[19px]">
                    {dateHeader}
                  </div>
                </div>
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              <span className="text-[13px] font-bold text-slate-800 flex items-center gap-2">
                                {note.author}
                                <span className="px-2 py-0.5 rounded bg-blue-50 text-blue-600 text-[10px] uppercase tracking-wider">Note</span>
                              </span>
