      ...
      days.push(
        <button
          ...
          className={`p-1.5 text-sm rounded-md transition-colors ${
            isSelected
              ? 'bg-primary text-white hover:bg-primary/90 font-bold shadow-sm'
              : isToday
        ...
        >
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 flex justify-between gap-2">
            <button
              type="button"
              onClick={handleClear}
              className="px-3 py-1.5 text-sm font-semibold text-red-600 bg-transparent hover:bg-red-50 hover:text-red-700 rounded-md transition-colors w-full border border-transparent"
            >
              Clear
            </button>
            <button
              type="button"
              onClick={handleToday}
              className="px-3 py-1.5 text-sm font-semibold text-primary hover:bg-primary/10 rounded-md transition-colors w-full border border-primary/20 shadow-sm"
            >
              Select Today
            </button>
          </div>
