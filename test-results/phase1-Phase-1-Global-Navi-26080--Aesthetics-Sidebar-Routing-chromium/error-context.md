...
- Name: phase1.spec.ts >> Phase 1: Global Navigation & Foundation Aesthetics >> Sidebar & Routing
- Location: tests\phase1.spec.ts:8:3
...
Locator: getByText('Client Health', { exact: true })
Expected: visible
Timeout: 5000ms
