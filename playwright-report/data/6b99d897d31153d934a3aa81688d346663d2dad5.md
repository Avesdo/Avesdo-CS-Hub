...
- Name: phase2.spec.ts >> Phase 2: The Dashboard >> Widgets (Unscheduled Projects, Recent Activity)
- Location: tests\phase2.spec.ts:37:3
...
Locator: getByText('Unscheduled Projects').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Unscheduled Projects').first()
