...
- Name: phase1.spec.ts >> Phase 1: Global Navigation & Foundation Aesthetics >> Overall Canvas Layout
- Location: tests\phase1.spec.ts:55:3
...
Locator: locator('.h-\\[calc\\(100vh-var\\(--header-height\\)\\)\\]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.h-\\[calc\\(100vh-var\\(--header-height\\)\\)\\]').first()
