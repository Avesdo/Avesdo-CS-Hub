...
export default function ServiceHub() {
  ...
  const handleStatusChange = async (s: any, newStatus: string) => {
  ...
  const baseFiltered = useMemo(() => {
    return services.filter((s) => {
      ...
      if (projectFilter.length > 0 && !projectFilter.includes(s.projectName || 'None'))
        return false;
      if (
      ...
      if (managerFilter.length > 0 && !managerFilter.includes(s.manager || 'Unassigned'))
        return false;
            ...
            <table className="w-full text-left bg-white border-separate border-spacing-0">
              <thead className="sticky top-0 z-50 bg-white/90 backdrop-blur-md">
                <tr className="bg-slate-50/80 text-slate-500 text-[11px] font-bold tracking-wider h-[45px]">
                  <th className="group/th sticky left-0 z-40 bg-slate-50/90 backdrop-blur-md border-b border-border border-r-0 px-6 py-3">
                  ...
                  <th className="group/th px-6 py-3 border-l-0 border-b border-border">
                    <div className="flex items-center gap-1.5">
                      <span
                        className="cursor-pointer hover:text-primary transition-colors flex items-center gap-1.5"
                  ...
                  <th className="group/th px-6 py-3 border-b border-border">
                    <div className="flex items-center gap-1.5">
                      <span
                        className="cursor-pointer hover:text-primary transition-colors flex items-center gap-1.5"
                  ...
                  {activeTab !== 'Included' && (
                    <th
                      className="px-6 py-3 border-b border-border cursor-pointer hover:text-primary transition-colors text-right"
                ...
                {tableData.map((s: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-3 text-[13px] text-muted-foreground font-medium border-l-0">
                        <TruncatedText
                      ...
                      <td className="px-6 py-3">{getTypeBadgeIconOnly(s.type, settings)}</td>
                      ...
                      <td className="px-6 py-3 text-[13px] text-muted-foreground font-medium whitespace-nowrap">
                        {sDate}
                      </td>
                      {activeTab !== 'Included' && (
                        <td className="px-6 py-3 text-[13px] font-bold text-foreground text-right whitespace-nowrap">
